...
const Navbar = () => {
  ...
  const toggleSidebar = () => {
    ...
    return (
      <div>
    <nav className="bg-blue-900 shadow-md backdrop-blur-sm  w-full fixed top-0 left-0 right-0 z-50">
      <div className="flex items-center justify-between h-[80px] px-4">
        ...
        <div className="hidden lg:flex space-x-6  lg:relative lg:left-10">
          <Link href="/" className="text-white hover:text-[#FFD700] font-semibold">Home</Link>
          <Link href="/contact" className="text-white hover:text-[#FFD700] font-semibold">Contact</Link>
          <Link href="/about" className="text-white hover:text-[#FFD700] font-semibold">About Us</Link>
        </div>
      ...
      <div
        className={`fixed inset-y-0 left-0  h-screen w-64 bg-blue-950 text-white transform ${
      ...
      >
        <div className="p-4">
          ...
          <ul className="space-y-4">
            ...
            <li>
              <Link href="/about" className="hover:text-[#FFD700]" onClick={toggleSidebar}>About Us</Link>
            </li>
          </ul>
        </div>
                </div>
