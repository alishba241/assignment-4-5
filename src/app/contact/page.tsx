...
function Contact() {
  return (
      <div className="mt-[140px] md:mt-[150px] mb-10 ">
      <h2 className=' font-bold text-4xl text-center text-blue-900'>Lets Contact us</h2>
  ...
  <div className="container mx-auto text-center px-4">
    ...
    <div className="relative w-[280px] md:w-[500px] mx-auto bg-blue-900  backdrop-filter backdrop-blur-lg p-6 md:p-8 rounded-lg shadow-lg space-y-6">
        ...
        <div>
          <input
            ...
            required
            className="w-full p-3 md:p-4 text-black rounded-lg placeholder:text-gray-500 border-2 border-transparent focus:border-blue-400 outline-none transition duration-300 bg-white bg-opacity-93"
          />
        </div>
        <div>
          <input
            ...
            required
            className="w-full p-3 md:p-4 text-black rounded-lg border-2  placeholder:text-gray-500 border-transparent focus:border-blue-400 outline-none transition duration-300 bg-white bg-opacity-93"
          />
        </div>
        <div>
          <input
        ...
        <div>
          <textarea
            ...
            className="w-full p-3 md:p-4 text-black rounded-lg border-2  placeholder:text-gray-500 border-transparent focus:border-blue-400 outline-none transition duration-300 bg-white bg-opacity-93 h-32 md:h-40 resize-none"
            required
          ></textarea>
        </div>
                <button
          ...
          type="submit"
          className="w-full py-3 md:py-4 bg-gradient-to-r from-blue-600 to-yellow-400 text-white rounded-lg font-bold hover:shadow-lg transform hover:scale-105 transition duration-300"
        >
          Send Message
        </button>
      </form>
